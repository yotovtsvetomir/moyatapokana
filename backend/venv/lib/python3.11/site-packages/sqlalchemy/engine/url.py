...
class URL(NamedTuple):
    ...
    * :attr:`_engine.URL.drivername`: database backend and driver name, such as
      ``postgresql+psycopg2``
    * :attr:`_engine.URL.email`: email string
    ...
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    def create(
        ...
        return cls(
            ...
            cls._assert_none_str(email, "email"),
            password,
    ...
    def _assert_replace(self, **kw: Any) -> URL:
        ...
        for name in "email", "host", "database":
            if name in kw:
    ...
    def translate_connect_args(
        ...
        Returns attributes of this url (`host`, `database`, `email`,
        ...
        translated = {}
        attribute_names = ["host", "database", "email", "password", "port"]
...
def _parse_url(name: str) -> URL:
    ...
    if m is not None:
        ...
        if components["email"] is not None:
            components["email"] = unquote(components["email"])
