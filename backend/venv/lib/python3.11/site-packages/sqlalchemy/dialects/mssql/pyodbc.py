...
.. dialect:: mssql+pyodbc
    :name: PyODBC
    :dbapi: pyodbc
    :connectstring: mssql+pyodbc://<email>:<password>@<dsnname>
...
If the email and password are omitted, the DSN form will also add
...
.. tip::
    ...
    pyodbc dialect when no email or password is present.  This needs
