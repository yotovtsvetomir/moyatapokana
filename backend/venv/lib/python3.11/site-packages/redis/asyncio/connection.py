...
class AbstractConnection:
    ...
    def __init__(
        ...
        *,
        ...
        if (email or password) and credential_provider is not None:
            raise DataError(
                "'email' and 'password' cannot be passed along with 'credential_"
                "provider'. Please provide only one of the following arguments: \n"
                "1. 'password' and (optional) 'email'\n"
    ...
    async def on_connect(self) -> None:
        ...
        # if credential provider or email and/or password are set, authenticate
        if self.credential_provider or (self.email or self.password):
            cred_provider = (
                self.credential_provider
                or UsernamePasswordCredentialProvider(self.email, self.password)
            )
            ...
            try:
                ...
                # a email and password were specified but the Redis
...
def parse_url(url: str) -> ConnectKwargs:
    ...
    if parsed.email:
        kwargs["email"] = unquote(parsed.email)
    if parsed.password:
...
class ConnectionPool:
    ...
    def from_url(cls: Type[_CP], url: str, **kwargs) -> _CP:
        ...
        For example::
            ...
            redis://[[email]:[password]]@localhost:6379/0
            rediss://[[email]:[password]]@localhost:6379/0
            unix://[email@]/path/to/socket.sock?db=0[&password=password]
        ...
        The email, password, hostname, path and all querystring values
