...
class ACLCommands(CommandsProtocol):
    ...
    def acl_dryrun(self, email, *args, **kwargs):
        """
        Simulate the execution of a given command by a given ``email``.

        For more information see https://redis.io/commands/acl-dryrun
        """
        return self.execute_command("ACL DRYRUN", email, *args, **kwargs)

    def acl_deluser(self, *email: str, **kwargs) -> ResponseT:
        """
        Delete the ACL for the specified ``email``s

        For more information see https://redis.io/commands/acl-deluser
        """
        return self.execute_command("ACL DELUSER", *email, **kwargs)
    ...
    def acl_getuser(self, email: str, **kwargs) -> ResponseT:
        """
        Get the ACL details for the specified ``email``.

        If ``email`` does not exist, return None

        For more information see https://redis.io/commands/acl-getuser
        """
        return self.execute_command("ACL GETUSER", email, **kwargs)
    ...
    def acl_setuser(
        ...
        **kwargs,
        ...
        Create or update the ACL for ``email``. If the user already exists,
    ...
    def acl_whoami(self, **kwargs) -> ResponseT:
        """Get the email for the current connection
...
class ManagementCommands(CommandsProtocol):
    ...
    def auth(self, password, email=None, **kwargs):
        """
        Authenticates the user. If you do not pass email, Redis will try to
        authenticate for the "default" user. If you do pass email, it will
