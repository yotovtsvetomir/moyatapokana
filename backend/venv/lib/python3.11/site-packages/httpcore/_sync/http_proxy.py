...
def build_auth_header(email: bytes, password: bytes) -> bytes:
    userpass = email + b":" + password
    ...
    def __init__(
        ...
        Parameters:
            ...
            proxy_auth: Any proxy authentication as a two-tuple of
                (email, password). May be either bytes or ascii-only str.
            proxy_headers: Any HTTP headers to use for the proxy requests.
                For example `{"Proxy-Authorization": "Basic <email>:<password>"}`.
        ...
        if proxy_auth is not None:
            email = enforce_bytes(proxy_auth[0], name="proxy_auth")
