...
class Request:
    ...
    -----------------
        ...
        validate_cert (bool): Set to true if the server certificate should be
            ...
            Enabled by default.
        auth_email (str): Username for HTTP authentication.
        ...
        proxy_email (str): Optional email to use when logging in
            to the proxy.
    ...
    body = user_agent = network_interface = \
        auth_email = auth_password = auth_mode = \
        proxy_host = proxy_port = proxy_email = proxy_password = \
