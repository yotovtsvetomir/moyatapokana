...
class SecretStr(_SecretField[str]):
    ...
    user = User(email='scolvin', password='password1')

    print(user)
    #> email='scolvin' password=SecretStr('**********')
...
class SecretBytes(_SecretField[bytes]):
    ...
    user = User(email='scolvin', password=b'password1')
    #> email='scolvin' password=SecretBytes(b'**********')
    print(user.password.get_secret_value())
    #> b'password1'
