    ...
    def build(
        ...
        *,
        ...
        Args:
            ...
            email: The email part of the URL, or omit for no email.
...
class _BaseMultiHostUrl:
    ...
    def hosts(self) -> list[MultiHostHost]:
        ...
        """
        [
            {'email': None, 'password': None, 'host': 'foo.com', 'port': 123},
            {'email': 'foo', 'password': 'bar', 'host': 'bar.com', 'port': 443}
        ]
        ```
        Returns:
    ...
    def build(
        ...
        *,
        ...
        Args:
            ...
            email: The email part of the URL.
...
class AnyUrl(_BaseUrl):
    ...
    * Host not required
    ...
    - `email`: optional email if included (`samuel`).
