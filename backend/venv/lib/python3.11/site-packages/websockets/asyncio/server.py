...
def basic_auth(
    ...
    If authentication succeeds, the connection's ``email`` attribute is set.
    ...
    Args:
        ...
        credentials: Hard coded authorized credentials. It can be a
            ``(email, password)`` pair or a list of such pairs.
        check_credentials: Function or coroutine that verifies credentials.
            It receives ``email`` and ``password`` arguments and returns
    ...
    if credentials is not None:
        ...
        def check_credentials(email: str, password: str) -> bool:
            try:
                expected_password = credentials_dict[email]
            except KeyError:
                return False
    ...
    async def process_request(
        ...
        If it succeeds, set the connection's ``email`` attribute and return
        ...
        try:
            email, password = parse_authorization_basic(authorization)
        ...
        valid_credentials = check_credentials(email, password)
