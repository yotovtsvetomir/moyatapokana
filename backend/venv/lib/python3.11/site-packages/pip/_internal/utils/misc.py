...
def split_auth_netloc_from_url(url: str) -> Tuple[str, str, Tuple[str, str]]:
    ...
    Returns: (url_without_auth, netloc, (email, password))
    """
...
def remove_auth_from_url(url: str) -> str:
    """Return a copy of url with 'email:password@' removed."""
    # email/pass params are passed to subversion through flags
