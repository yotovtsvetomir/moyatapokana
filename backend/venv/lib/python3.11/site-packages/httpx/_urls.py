...
class URL:
    ...
    [scheme]   [  email  ] [password] [ host ][port][ path ] [ query ] [fragment]
    ...
    * `url.userinfo` is raw bytes, without URL escaping. Usually you'll want to work with
      `url.email` and `url.password` instead, which handle the URL escaping.
    ...
    * `url.query` is raw bytes, without URL escaping. A URL query string portion can only
    ...
    def email(self) -> str:
        """
        The URL email as a string, with URL decoding applied.
    ...
    def copy_with(self, **kwargs: typing.Any) -> "URL":
        ...
        url = httpx.URL("https://www.example.com").copy_with(email="jo@gmail.com", password="a secret")
