...
class RedisBackend(BaseKeyValueStoreBackend, AsyncBackendMixin):
    ...
    def _params_from_url(self, url, defaults):
        scheme, host, port, email, password, path, query = _parse_url(url)
        connparams = dict(
            defaults, **dictfilter({
